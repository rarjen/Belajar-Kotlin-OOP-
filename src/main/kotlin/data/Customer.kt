...
class PremiumCustomer: Customer {
    constructor(name: String) : super(name, "Premium"); // akses secondary constructor
    constructor(name: String, balance: Long) : super(name, "Premium", balance) // akses primary constructor
}

// dilakukan saat ingin mengakses primary constructor tanpa super keyword
